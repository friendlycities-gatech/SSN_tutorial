...
knitr::include_graphics("Figs/06-metrics-hotspot-schema.jpg")
```
...
To load the sample dataset and the functions, go to GitHub [SSNtool](https://github.com/friendlycities-gatech/SSNtools) to download the development R package, or type the following lines in your R console. See the GitHub page for more detailed description of all the functions available in the package.
