...
There are a few packages for visualizing maps. We chose `tmap` in the end for its flexibility to switch between interactive maps and static plots. We also have some codes that use `ggpplot2` to generate other graphic visualizations. 
