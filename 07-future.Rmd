...
If you run into an issue with the `SSNtools` R package or this tutorial, please open an issue (for `SSNtools` [here](https://github.com/friendlycities-gatech/SSNtools/issues) and for R tutorial [here](https://github.com/friendlycities-gatech/SSN_tutorial/issues)) at the GitHub with an replicable example. 